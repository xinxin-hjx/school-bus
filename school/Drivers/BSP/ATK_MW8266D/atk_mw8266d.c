...
uint8_t atk_mw8266d_restore(void)
{
    ...
    ret = atk_mw8266d_send_at_cmd("AT+RESTORE", "OK", 1500);
...
{
    uint8_t ret;
    ret = atk_mw8266d_send_at_cmd("AT+RST", "OK", 1500);
    if (ret == ATK_MW8266D_EOK)
    {
        return ATK_MW8266D_EOK;
    }
...
uint8_t atk_mw8266d_ate_config(uint8_t cfg)
{
    ...
    switch (cfg)
    {
        case 0:
        {
            ret = atk_mw8266d_send_at_cmd("ATE0", "OK", 1200);   /* 关闭回显 */
            break;
        }
        case 1:
        {
            ret = atk_mw8266d_send_at_cmd("ATE1", "OK", 1200);   /* 打开回显 */
            break;
        }
        default:
        {
